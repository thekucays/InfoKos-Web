<?php
$image = mysql_fetch_array(mysql_query('SELECT * FROM gambar_kamar WHERE id=' . $_GET['id']));
?>
...
<h2>Edit Gambar Kamar</h2>
<form action="modul/kamar/aksi.php?act=edit_img" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $image['id'] ?>"/>
    <input type="hidden" name="kamar_id" value="<?php echo $image['kamar_id'] ?>"/>
